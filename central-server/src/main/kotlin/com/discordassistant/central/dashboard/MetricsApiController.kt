...
class MetricsApiController(private val registry: ConnectionRegistry) {
    ...
    fun pool(): Map<String, Any> {
        ...
        return mapOf(
            ...
            "guildPoolSizes" to sessions.groupingBy { it.guildId }.eachCount()
    ...
    fun guild(@PathVariable guildId: Long): Map<String, Any> {
        val pool = registry.byGuild(guildId)
        return mapOf(
            "guildId" to guildId,
            "providers" to pool.map {
                mapOf(
