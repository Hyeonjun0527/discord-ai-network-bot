...
data class MultiResponseOperationsDashboardResponse(
    ...
    val decisionSummary: com.discordassistant.central.multiresponse.application.MultiResponseDecisionSummary,
) {
    companion object {
        fun from(
            summary: com.discordassistant.central.multiresponse.application.MultiResponseOperationsSummary,
...
data class ProviderFanoutLoadDashboardResponse(
    ...
    companion object {
        fun from(
            load: com.discordassistant.central.multiresponse.application.ProviderFanoutLoadSummary,
            index: Int,
            audience: DashboardAudience,
