    ...
    fun decideAndLog(
        ...
        decisionLog.append(
            DecisionLogRecord(
                ...
                judgeModelVersion = provenance.judgeModelVersion,
                judgePromptVersion = provenance.judgePromptVersion,
                fewShotSetId = provenance.fewShotSetId,
                fewShotVersion = provenance.fewShotVersion,
                rawWindowHash = provenance.rawWindowHash,
                rawWindowMessageRefs = provenance.rawWindowMessageRefs,
                seed = seed,
                ...
                shadowBaselineAction = provenance.shadowBaselineAction,
                finalDecisionSource = provenance.finalDecisionSource,
