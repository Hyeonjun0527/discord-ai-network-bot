...
class DiscordGatewayStatus(
    ...
    @Volatile var typingIntentEnabled: Boolean = false
    ...
    fun markStarting(
        ...
        typingIntent: Boolean = false,
    ) {
        ready = false
        messageContentIntentEnabled = messageContentIntent
        typingIntentEnabled = typingIntent
...
class DiscordGatewayHealthIndicator(
    ...
    override fun health(): Health {
        ...
        val granted =
            GatewayIntentPolicy
                .intents(
                    messageContentIntentEnabled = status.messageContentIntentEnabled,
                    typingIntentEnabled = status.typingIntentEnabled,
                ).toSet()
        ...
        return builder
            ...
            .withDetail("typingIntentEnabled", status.typingIntentEnabled)
