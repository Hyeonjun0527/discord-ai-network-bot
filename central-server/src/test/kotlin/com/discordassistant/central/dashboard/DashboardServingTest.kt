...
class DashboardServingTest
    ...
    constructor(
        ...
        fun `정적 대시보드가 AI 네트워크 섹션을 포함한다`() {
            ...
            assertTrue(html.contains("""id="routingExperienceBoard""""))
            assertTrue(html.contains("""id="routingPolicyState""""))
            assertTrue(html.contains("""id="routingCandidateCount""""))
            assertTrue(html.contains("""id="routingChoiceState""""))
            assertTrue(html.contains("""id="routingSelectedModel""""))
            assertTrue(html.contains("""id="routingResultCards""""))
            ...
            assertTrue(html.contains("""id="qualityExperienceBoard""""))
            assertTrue(html.contains("""id="qualityFeedbackCount""""))
            assertTrue(html.contains("""id="qualityOpenReports""""))
            assertTrue(html.contains("""id="qualityReviewCount""""))
            assertTrue(html.contains("""id="qualityResultCards""""))
            ...
            assertTrue(html.contains("""id="advancedExperienceBoard""""))
            assertTrue(html.contains("""id="multiModeState""""))
            assertTrue(html.contains("""id="multiFanoutState""""))
            assertTrue(html.contains("""id="multiRunCount""""))
            assertTrue(html.contains("""id="multiResultCards""""))
            ...
            assertTrue(js.contains("selectRoutingModel"))
            assertTrue(js.contains("focusRoutingTask"))
            ...
            assertTrue(js.contains("renderQualityExperience"))
            assertTrue(js.contains("focusQualityTask"))
            ...
            assertTrue(js.contains("renderMultiExperience"))
            assertTrue(js.contains("focusAdvancedTask"))
            assertTrue(js.contains("if (name === \"model\")"))
            assertTrue(js.contains("if (name === \"quality\")"))
            assertTrue(js.contains("if (name === \"advanced\")"))
        ...
        fun `정적 대시보드가 프리셋과 RAG 작업 흐름 보드를 포함한다`() {
            ...
            assertTrue(html.contains("""id="presetImportPreviewCards""""))
            ...
            assertTrue(html.contains("""id="knowledgeResultCards""""))
            ...
            assertTrue(css.contains(".result-card"))
            assertTrue(js.contains("updatePresetExperience"))
            assertTrue(js.contains("focusPresetTask"))
            assertTrue(js.contains("selectLocalPresetFromElement"))
            assertTrue(js.contains("selectPublishedPresetFromElement"))
            assertTrue(js.contains("currentChannelIdValue"))
            ...
            assertTrue(js.contains("renderKnowledgeSearchCards"))
            assertTrue(js.contains("renderKnowledgeEvalCards"))
            assertTrue(js.contains("select-knowledge-job"))
        ...
        fun `공개 프리셋 웹 카탈로그가 목록 미리보기 가져오기를 제공한다`() {
            ...
            assertTrue(html.contains("""id="webReadiness""""))
            assertTrue(html.contains("""id="webReadinessMessage""""))
            ...
            assertTrue(js.contains("/api/ai-network/presets/web-readiness"))
            ...
            assertTrue(js.contains("refreshWebReadiness"))
            assertTrue(js.contains("requiresAdminToken"))
