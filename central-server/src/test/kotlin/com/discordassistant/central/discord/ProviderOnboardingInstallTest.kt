...
class ProviderOnboardingInstallTest {
    ...
    fun `macOS — brew + 바이너리 + 토큰·relay`() {
        ...
        assertTrue(s.contains("releases/latest/download/discord-ai-agent-network-bot-macos"), s)
        assertFalse(s.contains("discord-ai.yeon.world/download"), s)
        assertTrue(s.contains("curl -L -o discord-ai-agent-network-bot-macos"), s)
        assertTrue(s.contains("chmod +x discord-ai-agent-network-bot-macos"), s)
        assertTrue(s.contains("codesign --force --deep --sign - discord-ai-agent-network-bot-macos"), s)
        assertTrue(s.contains("./discord-ai-agent-network-bot-macos"), s)
    ...
    fun `Windows — winget + PowerShell(관리자) + exe`() {
        ...
        assertTrue(s.contains("releases/latest/download/discord-ai-agent-network-bot-windows.exe"), s)
        assertFalse(s.contains("discord-ai.yeon.world/download"), s)
        assertTrue(s.contains("discord-ai-agent-network-bot-windows.exe"), s)
        assertTrue(s.contains(".\\discord-ai-agent-network-bot-windows.exe"), s)
        assertFalse(s.contains("discord-ai-agent-network-bot-macos"), s)
    ...
    fun `Linux — install_sh + linux 바이너리`() {
        ...
        assertTrue(s.contains("releases/latest/download/discord-ai-agent-network-bot-linux"), s)
        assertFalse(s.contains("discord-ai.yeon.world/download"), s)
        assertTrue(s.contains("curl -L -o discord-ai-agent-network-bot-linux"), s)
        assertTrue(s.contains("chmod +x discord-ai-agent-network-bot-linux"), s)
        assertTrue(s.contains("./discord-ai-agent-network-bot-linux"), s)
        assertFalse(s.contains("discord-ai-agent-network-bot-macos"), s)
        assertFalse(s.contains("discord-ai-agent-network-bot-windows.exe"), s)
