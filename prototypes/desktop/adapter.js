...
export const api = {
  ...
  async getUpdateInfo() {
    /* @proto-only */ if (USE_MOCK) { if (globalThis.__HANG_UPDATE_INFO) return new Promise(() => {}); await delay(60); return { ...(globalThis.__MOCK_UPDATE_INFO || MOCK.updateInfo) }; } /* @end-proto-only */
