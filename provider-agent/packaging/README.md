...
- Linux: `packaging/systemd/discord-ai-provider-agent.service` → `systemctl --user`(시스템 유닛 아님).
...
- 설정: `~/.config/discord-ai-provider-agent/config.json`(시크릿 `0600`).
...
- 로컬 빌드 체크섬: `shasum -a 256 dist/discord-ai-provider-agent > SHA256SUMS`
