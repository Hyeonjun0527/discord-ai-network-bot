...
class DiscordAiNetworkBot < Formula
  ...
  on_macos do
    url "https://github.com/Hyeonjun0527/discord-assistant/releases/download/agent-v#{version}/discord-ai-network-bot-macos"
    sha256 "__MACOS_SHA256__"
  end

  on_linux do
    url "https://github.com/Hyeonjun0527/discord-assistant/releases/download/agent-v#{version}/discord-ai-network-bot-linux"
